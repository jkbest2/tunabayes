...
```{r fig.cap="*Figure C.7* Prior (black) and posterior distributions of the coefficient of variation of catch observations. All fits here inclded divergent transitions."}
